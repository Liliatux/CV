						...
						<div className="ui big relaxed divided list">
							...
							<div className="item">
								...
								<div className="content">
									...
									<div className="description"><a href="https://liliatux.github.io/Truk_IOT/"><i className="search icon"></i>Apperçu</a></div>
								</div>
							</div>
							<div className="item">
								<i className="large github middle aligned icon"></i>
								<div className="content">
									...
									<div className="description"><a href="https://liliatux.github.io/adap_ta_boite/"><i className="search icon"></i>Apperçu</a></div>
								</div>
							</div>
						</div>
					</div>
